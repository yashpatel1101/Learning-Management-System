...
$sql = "SELECT * FROM grade WHERE username = '$name' ";
        ...
        <center>
            ...
            <table id="table1" border="1px">
                <tr>
                    ...
                    <th class="table_th">Obtaine Marks</th>
                    <th class="table_th">Out of Marks</th>
                </tr>
                ...
                ?>
                    ...
                    <tr>
                        ...
                        <td class="table_td">
                            <?php echo "{$info['gain_marks']}"; ?>
                        </td>
                        <td class="table_td">
                            <?php echo "{$info['out_of_marks']}"; ?>
                        </td>
